...
function Projects() {
  ...
  useEffect(() => {
    if (lang == "en") {
      ...
      setHome("Geri Dön");
      setCybershotsdesc(
        "'Cyber shots', React, Unsplash API ve Tailwind kullanılarak geliştirilmiş bir uygulamadır. Kullanıcılara, Unsplash'a alternatif olarak, siberpunk temasıyla özelleştirilmiş yüksek kaliteli, telifsiz görüntüleri sunmak için Unsplash API kullanır. Tailwind CSS ile kullanıcı arayüzü yüksek özelleştirilebilir ve görsel olarak çekici bir deneyim sağlar."
      );
      setCyberblogsdesc(
        "'Cyber ​​Blogs', Tailwind CSS ile oluşturulmuş, teknolojiyle ilgili kişisel blog gönderilerimi paylaşmak için bir platform olarak tasarlanmış bir React uygulamasıdır. Uygulama, blog yazılarımı okumak için basit ve kullanıcı dostu bir arayüzün yanı sıra mevcut gönderileri yönetmek ve aramak için kolaylaştırılmış bir yol sunar ."
      );
      setTimelessdesc(
        "'Timeless Love', çiftlerin ne kadar süredir birlikte olduklarını hesaplamalarına yardımcı olmak için tasarlanmış, Tailwind CSS ile oluşturulmuş, React tabanlı bir uygulamadır. Uygulama, kullanıcıların yıl dönümü tarihlerini girebilecekleri ve uygulamanın birlikte oldukları gün, ay ve yılları hesaplayıp gösterebileceği basit ve sezgisel bir kullanıcı arayüzü sunar."
      );
    }
  }, [lang]);
  return (
    <div className="text-white">
      ...
      <div className="grid grid-cols-1 mt-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <a href="https://github.com/eren-eroglu/cyber-shots " target="_blank" rel="noopener noreferrer">   <img className="w-full mb-4" src={cyberShots} alt="Project 1" /> </a>
          <h2 className="text-lg font-bold mb-2">
            Project 1: <span className="text-purple-400">Cyber Shots</span>{" "}
          </h2>
          <p className="text-gray-400">{cybershotsdesc}</p>
      <div className="w-full flex justify-end"> <a href="https://github.com/eren-eroglu/cyber-shots">   <FiExternalLink className="" size={25}/></a></div>
        </div>
        <div className="bg-gray-800  bg-opacity-50 rounded-lg p-6">
       <a href="https://github.com/eren-eroglu/digital-dreamer" target="_blank" rel="noopener noreferrer">  <img className="w-full mb-4" src={cyberBlogs} alt="Project 2" /></a> 
          <h2 className="text-lg font-bold mb-2">
            Project 2: <span className="text-purple-400">Cyber Blogs</span>
          </h2>
          <p className="text-gray-400">{cyberblogsdesc}</p> <div className="w-full flex justify-end"> <a href="https://github.com/eren-eroglu/digital-dreamer">   <FiExternalLink className="" size={25}/></a></div>
        </div>
        <div className="bg-gray-800  bg-opacity-50 rounded-lg p-6">
        <a href="https://github.com/eren-eroglu/timeless-love" target="_blank" rel="noopener noreferrer"> <img className="w-full mb-4 " src={timelessLove} alt="Project 3" /></a> 
          <h2 className="text-lg font-bold mb-2">
            Project 3: <span className="text-purple-400">Timeless Love</span>
          </h2>
          <p className="text-gray-400">{timelessdesc}</p> <div className="w-full flex justify-end"> <a href="https://github.com/eren-eroglu/timeless-love">   <FiExternalLink className="" size={25}/></a></div>
        </div>
      </div>
      ...
      <a href="https://github.com/eren-eroglu" target="_blank" rel="noopener noreferrer">
